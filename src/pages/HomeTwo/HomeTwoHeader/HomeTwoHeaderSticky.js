      ...
      <>
         <header>
            <div className="header__area p-relative header__transparent">
               <div id="header__sticky" className={'sticky header__bottom header__bottom-2'}>
                            ...
                            <div className="main-menu menu_wrapper_one">
                                 <nav id="mobile-menu">
                                    <ul>
                                       ...
                                       <li><NavLink to="/about">People </NavLink></li>
                                       <li>
                                       ...
                                       <li>
                                          <NavLink to="/portfolio">Comparasion</NavLink>
                                          {/* <ul className="submenu">
                                       ...
                                       <li>
                                          <NavLink to="/blogs">Time-series</NavLink>
                                          {/* <ul className="submenu">
                                             <li><NavLink to="/blogs">Blog</NavLink></li>
                                             <li><NavLink to="/blogDetails">Blog Details</NavLink></li>
                                          </ul> */}
                                       </li>
                                       <li><NavLink to="/contact">Data Analytics</NavLink></li>
                                    </ul>
                                 </nav>
                              </div>
...
export default HomeTwoHeaderSticky;